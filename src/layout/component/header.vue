<template>
	<el-header class="layout-header" height="50" :style="{'position': 'fixed','width': '100%','z-index': '2','padding':'0','padding-right':isCollapseWidth?'64px':'220px'}">
		<NavBarsIndex />
	</el-header>
</template>
...
export default {
	...
	setup() {
		...
		watch(()=>store.state.themeConfig.isCollapse,(newProps, oldProps) => {		
